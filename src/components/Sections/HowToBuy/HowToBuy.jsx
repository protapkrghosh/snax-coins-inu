        ...
        <Container>
          ...
          <div className='2xl:mt-[85px] xl:mt-[85px] lg:mt-[80px] md:mt-[60px] mt-[40px]'>
            ...
            <div className='2xl:ml-[4px] xl:ml-[4px] lg:ml-[4px] 2xl:space-y-[-10px] xl:space-y-[-10px] lg:space-y-[-10px]' data-aos="fade-up"
              ...
              <img className='2xl:ml-[240px] xl:ml-[240px] lg:ml-[240px] mx-auto 2xl:w-auto xl:w-[10%] lg:w-[10%] md:w-[20%] w-[18%]' src={cardImage} alt="image" />
            ...
            <div className='2xl:mt-[-170px] xl:mt-[-110px] lg:mt-[-110px] md:mt-[50px] mt-[40px] 2xl:ml-[860px] xl:ml-[660px] lg:ml-[520px] 2xl:space-y-[-10px] xl:space-y-[-10px] lg:space-y-[-10px]' data-aos="fade-up"
              ...
              <img className='2xl:ml-[240px] xl:ml-[240px] lg:ml-[240px] mx-auto 2xl:w-auto xl:w-[24%] lg:w-[24%] md:w-[20%] w-[18%]' src={cardImage} alt="image" />
              ...
              <div className='2xl:w-[100%] xl:w-[99%] lg:w-[99%] md:w-[80%] p-[1px] bg-gradient-to-l from-[#F8B515] to-[#0FC1C7] lg:mx-0 md:mx-auto rounded-[30px] w-fit'>
                <div className='bg-[#18534f] 2xl:p-[40px] xl:p-[30px] lg:p-[20px] rounded-[30px] md:p-[30px] p-[20px]'>
                  <p className='text-[#FFF] 2xl:text-[28px] xl:text-[24px] lg:text-[20px] md:text-[20px] text-[18px] xl:leading-[33.6px] xl:tracking-[0.84px]'>Get some <span className='bg-clip-text text-transparent bg-gradient-to-l from-[#F8B515] to-[#0FC1C7]'>BNB</span></p>
                  <p className='2xl:mt-[15px] xl:mt-[15px] lg:mt-[10px] md:mt-[8px] mt-[8px] text-[#E7D7CB] 2xl:text-[18px] xl:text-[14px] lg:text-[12px] md:text-[14px] text-[12px] 2xl:leading-[28.8px] 2xl:tracking-[0.54px]'>Have BNB in your wallet to switch to skillSolona. If you don't have any BNB, you con buy directly on metamosk, transfer from another wollet, or buy on another exchange and send it to your wollet.</p>
                </div>
              </div>
              {/* card shadow image  */}
              <div>
            ...
            {/* ----------- card 4 --------- */}
            <div className='2xl:mt-[-170px] xl:mt-[-170px] lg:mt-[-190px] md:mt-[50px] mt-[40px] 2xl:ml-[860px] xl:ml-[660px] lg:ml-[520px] 2xl:space-y-[-10px] xl:space-y-[-10px] lg:space-y-[-10px]' data-aos="fade-up"
              data-aos-duration="2400">
              <img className='2xl:ml-[240px] xl:ml-[240px] lg:ml-[240px] mx-auto 2xl:w-auto xl:w-auto lg:w-auto md:w-[20%] w-[18%]' src={cardImage} alt="image" />

              <div className='2xl:w-[100%] xl:w-[99%] lg:w-[99%] md:w-[80%] p-[1px] bg-gradient-to-l from-[#F8B515] to-[#0FC1C7] lg:mx-0 md:mx-auto rounded-[30px] w-fit'>
                <div className='bg-[#18534f] 2xl:p-[40px] xl:p-[30px] lg:p-[20px] rounded-[30px] md:p-[30px] p-[20px]'>
                  <p className='text-[#FFF] 2xl:text-[28px] xl:text-[24px] lg:text-[20px] md:text-[20px] text-[18px] xl:leading-[33.6px] xl:tracking-[0.84px]'>Swap BNB for <span className='bg-clip-text text-transparent bg-gradient-to-l from-[#F8B515] to-[#0FC1C7]'>KillSolana</span></p>
                  <p className='2xl:mt-[15px] xl:mt-[15px] lg:mt-[10px] md:mt-[8px] mt-[8px] text-[#E7D7CB] 2xl:text-[18px] xl:text-[14px] lg:text-[12px] md:text-[14px] text-[12px] 2xl:leading-[28.8px] 2xl:tracking-[0.54px]'>Switch BNB for #KillSolana. We have ZERO toxes so you don't need to worry about buying with a specific slippage, although you may need to use slippage during times of market volatility. HOLD KillSolana BNB for 1000x ATH Growth + s</p>
                </div>
              </div>
              {/* card shadow image  */}
              <div>
